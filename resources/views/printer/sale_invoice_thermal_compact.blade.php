...
<div class="receipt">
  ...
  @if($doctor)<div class="pair"><span>Dr:{{ $doctor }}</span></div>@endif
  @if($patient)<div class="pair"><span>Pt:{{ $patient }}</span></div>@endif
  ...
  <div class="totals">
    ...
    @endif
    @if($showTotalDue)
      <div class="pair total"><span>TOTAL DUE:{{ number_format($customerTotalDue, 2) }}</span></div>
    @endif
  </div>
  @if($footerNote !== '')
    <div class="hr"></div>
