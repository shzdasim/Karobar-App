// resources/js/components/topbar-templates/GradientTopbar.jsx
...
export default function GradientTopbar() {
  ...
  return (
    <>
      <div className="bg-gradient-to-r from-white via-gray-50 to-white dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 border-b border-gray-200 dark:border-slate-700 w-full max-w-full overflow-hidden">
        <div className="flex items-center h-12 px-3 w-full min-w-0">
          ...
          <div className="flex items-center gap-2 mr-4 flex-shrink-0">
            ...
            <span className="text-sm font-bold bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-300 bg-clip-text text-transparent whitespace-nowrap">{brandName}</span>
          </div>
            ...
            {getFilteredItems(flatMenu).map((item) => {
              ...
              return (
                <Link
                  key={item.path}
                  to={item.path}
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-sm font-medium transition-all duration-200 hover:bg-gray-100 dark:hover:bg-slate-800"
      ...
      {openDropdown && (() => {
        ...
        return (
          <div
            ref={dropdownRef}
            className="fixed bg-white dark:bg-slate-800 rounded-2xl shadow-2xl ring-1 ring-gray-200 dark:ring-slate-700 py-2 z-[99999]"
            style={{ top: dropdownPosition.top, left: dropdownPosition.left, minWidth: '180px' }}
          >
            <div className="px-3 py-2 mx-2 rounded-xl mb-1" style={{ background: `linear-gradient(135deg, ${colors.light}, ${colors.light}80)` }}>
